...
const Tambah = () => {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["syarat-ketentuan"] });
      toast.success("Syarat & Ketentuan baru ditambahkan!");
      navigate("/admin/syarat-ketentuan", { replace: true });
    },
    onError: () => {
      toast.error("Gagal menambah Syarat & Ketentuan baru");
    },
  });
    ...
    <>
      <BreadCrumb
        ...
        breadcrumb={[
          ...
          {
            title: "Tambah",
            href: "/admin/syarat-ketentuan/tambah",
            active: true,
          },
        ]}
      />
      ...
      <div className="bg-white rounded-lg p-5 flex-1">
        ...
        <FormProvider {...method}>
          <form onSubmit={method.handleSubmit(handleSubmit)}>
            ...
            <SelectSubKategori kategoriId="3" />
