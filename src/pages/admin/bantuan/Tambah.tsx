...
const Tambah = () => {
  ...
  const mutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success("Bantuan baru ditambahkan!");
      navigate("/admin/bantuan", { replace: true });
    },
    onError: () => {
      toast.error("Gagal menambah bantuan baru");
    },
  });

  const handleSubmit = (data: any) => {
    mutation.mutate({
      body: { ...data, header_image: gambar.path, content: bantuan },
      user,
    });
  };
  ...
  return (
    <>
      <BreadCrumb
        ...
        breadcrumb={[
          { title: "Bantuan", href: "/admin/bantuan", active: false },
          { title: "Tambah", href: "/admin/bantuan/tambah", active: true },
        ]}
      />
      ...
      <div className="bg-white rounded-lg p-5 flex-1">
        ...
        <FormProvider {...method}>
          <form onSubmit={method.handleSubmit(handleSubmit)}>
            ...
            <SelectSubKategori kategoriId="1" />
